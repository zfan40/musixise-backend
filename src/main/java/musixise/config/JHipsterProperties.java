...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "musixise@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "musixise API";

        private String description = "musixise API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "musixise";
